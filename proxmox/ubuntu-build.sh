...
# Prompt the user for credentials and SSH key
read -p "Enter your username: " username
read -s -p "Enter your password: " password
echo
read -p "Enter the path to your SSH public key: " sshkey
...
for version in "${versions[@]}"; do
    ...
    qm importdisk $vmid $image ceph01
    qm set $vmid --scsihw virtio-scsi-pci --scsi0 ceph01:vm-${vmid}-disk-0
    qm set $vmid --ide2 ceph01:cloudinit
